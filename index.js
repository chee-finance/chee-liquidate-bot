...
// const vToken = '0xD927502Da7A7759A132469212c7fa69d2198e344';
...
const [borrower, vToken, underlying, collateral, repayAmount] = args
...
async function liquidateBorrow(instance, token){
    try {
        ...
        // approve
        let txObject = await token.methods.approve(vToken, defaultAmount)
        ...
        receipt = await tx.waitReceipt()
        console.log(`liquidate ${borrower} finished!`)
